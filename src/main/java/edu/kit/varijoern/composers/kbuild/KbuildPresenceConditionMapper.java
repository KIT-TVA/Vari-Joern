...
public class KbuildPresenceConditionMapper implements PresenceConditionMapper {
    ...
    private final @NotNull FilePresenceConditionMapper filePresenceConditionMapper;
    private final @NotNull Map<Path, LinePresenceConditionMapper> linePresenceConditionMappers;
     ...
     */
    public KbuildPresenceConditionMapper(@NotNull FilePresenceConditionMapper filePresenceConditionMapper,
                                         @NotNull Map<Path, LinePresenceConditionMapper> linePresenceConditionMappers,
