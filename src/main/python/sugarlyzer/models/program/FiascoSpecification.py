    ...
    def parse_make_output(self, make_output_file: Path) -> List[Dict]:
        ...
        with open(make_output_file, "r") as make_output:
            ...
            for line in make_output:
                ...
                elif line.startswith("x86_64-linux-gnu"):
                    # Compile call.
                    compile_call = True
                    # Reset data collected for compile call.
                    file_path = None
                    included_files = []
                    included_dirs = []

                if compile_call:
                    # Resolve name of the file that is about to be compiled.
                    ...
                    if not line or not line.endswith("\\"):
                        compile_call = False
                        make_entry = {'file_pattern': file_path.replace('.', r'\.') + '$',
